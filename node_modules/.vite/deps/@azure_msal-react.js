...
var RegionDiscovery = (
  ...
  function() {
    ...
    RegionDiscovery2.prototype.getRegionFromIMDS = function(version4, options) {
      var _a;
      return __awaiter2(this, void 0, void 0, function() {
        return __generator2(this, function(_b) {
          ...
          return [2, this.networkInterface.sendGetRequestAsync(Constants.IMDS_ENDPOINT + "?api-version=" + version4 + "&format=text", options, Constants.IMDS_TIMEOUT)];
        });
      });
    };
...
var BrowserCacheManager = (
  ...
  function(_super) {
    ...
    BrowserCacheManager2.prototype.getWrapperMetadata = function() {
      ...
      var version4 = this.internalStorage.getItem(InMemoryCacheKeys.WRAPPER_VER) || Constants.EMPTY_STRING;
      return [sku, version4];
    };
    ...
    BrowserCacheManager2.prototype.getItemCookie = function(cookieName) {
      var name4 = encodeURIComponent(cookieName) + "=";
      ...
      for (var i = 0; i < cookieList.length; i++) {
        ...
        if (cookie.indexOf(name4) === 0) {
          return decodeURIComponent(cookie.substring(name4.length, cookie.length));
        }
      }
      return Constants.EMPTY_STRING;
    };
...
var BrowserPerformanceMeasurement = (
  /** @class */
  function() {
    function BrowserPerformanceMeasurement2(name4, correlationId) {
      this.correlationId = correlationId;
      this.measureName = BrowserPerformanceMeasurement2.makeMeasureName(name4, correlationId);
      this.startMark = BrowserPerformanceMeasurement2.makeStartMark(name4, correlationId);
      this.endMark = BrowserPerformanceMeasurement2.makeEndMark(name4, correlationId);
    }
    BrowserPerformanceMeasurement2.makeMeasureName = function(name4, correlationId) {
      return "msal.measure." + name4 + "." + correlationId;
    };
    BrowserPerformanceMeasurement2.makeStartMark = function(name4, correlationId) {
      return "msal.start." + name4 + "." + correlationId;
    };
    BrowserPerformanceMeasurement2.makeEndMark = function(name4, correlationId) {
      return "msal.end." + name4 + "." + correlationId;
    };
...
var ClientApplication = (
  ...
  function() {
    ...
    ClientApplication2.prototype.initializeWrapperLibrary = function(sku, version4) {
